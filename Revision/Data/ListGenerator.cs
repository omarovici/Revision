    ...
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ProductsList = new List<Product>()
            {
                new Product02()
                {
                    ProductID = 1000, ProductName = "Chai", Category = "Beverages",
                    UnitPrice = 18.00M, UnitsInStock = 100
                },
                new Product02()
                {
                    ProductID = 1001, ProductName = "Chang", Category = "Beverages",
                    UnitPrice = 19.0000M, UnitsInStock = 17
                },
                new Product02
                {
                    ProductID = 1002, ProductName = "Aniseed Syrup", Category = "Condiments",
                    UnitPrice = 10.0000M, UnitsInStock = 13
                },
                new Product02
                {
                    ProductID = 1003, ProductName = "Chef Anton's Cajun Seasoning", Category = "Condiments",
                    UnitPrice = 22.0000M, UnitsInStock = 53
                },
                new Product02
                {
                    ProductID = 1004, ProductName = "Chef Anton's Gumbo Mix", Category = "Condiments",
                    UnitPrice = 21.3500M, UnitsInStock = 0
                },
                new Product02
                {
                    ProductID = 1005, ProductName = "Grandma's Boysenberry Spread", Category = "Condiments",
            ...
            CustomersList = (from e in XDocument
                    .Load("/Users/macbook/Documents/Study Corner/ASP.NET-Revision/Revision/Revision/Data/Customers.xml")
